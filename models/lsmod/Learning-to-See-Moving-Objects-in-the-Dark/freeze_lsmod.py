...
def main():
    ...
    with graph.as_default():
        ...
        in_image = tf.compat.v1.placeholder(tf.float32, [None, TEST_CROP_FRAME, 512, 512, 4], name='input')
        gt_image = tf.compat.v1.placeholder(tf.float32, [None, TEST_CROP_FRAME, 512, 512, 3], name='gt')
        ...
        tf.io.write_graph(graphdef, './1_checkpoint/16_bit_HE_to_HE_gt', 'lsmod.pb', as_text=False)
