...
def main():
    ...
    in_image = tf.compat.v1.placeholder(tf.float32, [None, TEST_CROP_FRAME, None, None, 4])
    gt_image = tf.compat.v1.placeholder(tf.float32, [None, TEST_CROP_FRAME, None, None, 3])
    out_image = network(in_image)

    with tf.io.gfile.GFile("./1_checkpoint/16_bit_HE_to_HE_gt/modelfilnal.pb", "rb") as f:
